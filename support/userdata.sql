TRUNCATE TABLE grocery_list;INSERT INTO grocery_list (id,userid,name,filtered,colorid,sourcelistid,storeid,categoryid) VALUES 
  ...
  (4,1,'My Walmart List',true,5,2,2,0),
  (5,1,'My Marketplace List',true,19,2,3,0),
  (3,1,'My Aldi List',true,12,2,1,0);
...
TRUNCATE TABLE listitem;INSERT INTO listitem (listitemid,listid,productid,categoryid,brandid,unitid,urgencyid,unitcount,itemcount,purchased,hidden) VALUES 
  (1,2,85,13,77,null,3,0,1,false,false),
  (2,2,17,2,0,null,3,0,4,false,false);
...
TRUNCATE TABLE productstore;INSERT INTO productstore (productid,storeid,userid) VALUES 
  ...
  (70,1,10),
  (14,2,10);
TRUNCATE TABLE urgency;INSERT INTO urgency (urgencyid,name) VALUES 
  (1,'Very'),
  (2,'Somewhat'),
  (3,'Not');
SELECT setval('urgency_urgencyid_seq', (SELECT MAX(urgencyid) FROM urgency));
TRUNCATE TABLE color;INSERT INTO color (colorid,userid,colorname,rgbvalue) VALUES 
  (0,0,'default',''),
  (1,0,'black','#000000'),
  (2,0,'white','#FFFFFF'),
  (3,0,'red','#FF0000'),
  ...
  (35,0,'peanut','#795C34');
SELECT setval('color_colorid_seq', (SELECT MAX(colorid) FROM color));
